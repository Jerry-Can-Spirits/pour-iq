...
//
// Copy: field labels Drink / Price / GP mirror the menu table's own
// vocabulary; the button reads "Update price" (not bare "Update") so it
// names the local recalculation honestly and never reads as save/commit,
// which the demo never does. All approved 2026-07-16.
